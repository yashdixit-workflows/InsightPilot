                    ...
                    with st.spinner("InsightPilot is analyzing..."):
                        ...
                        for model_name in MODEL_CHAIN:
                            try:
                                ...
                                last_err = e
                                err_str = str(e)
                                if any(x in err_str for x in ["429", "RESOURCE_EXHAUSTED", "503", "UNAVAILABLE", "500", "INTERNAL"]):
                                    thoughts_list.append(f"{chr(9888)} {model_name} rate limited or unavailable, trying next model...")
                                    if "runner" in st.session_state:
                                        del st.session_state.runner
                                    continue
                                else:
